    ...
    <div className="space-y-2">
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-card border border-border-light bg-white text-[12px] font-medium text-medium-gray hover:text-charcoal hover:border-border-medium disabled:opacity-40 disabled:cursor-not-allowed"
          ...
          <div className="flex flex-wrap gap-1.5">
            {OPTIONS.map((o) => (
              <button
                ...
                className="px-2.5 py-1 rounded-card border border-border-light bg-white text-[12px] font-medium text-medium-gray hover:text-charcoal hover:border-border-medium"
              >
                {o.label}
              </button>
            ))}
